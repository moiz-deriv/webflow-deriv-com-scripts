...
const languages = ['ar','bn','de','en','es','fr','it','ko','pl','pt','ru','si','sw','th', 'tr','vi','zh_cn','zh_tw'];
...
const current_path = window.location.pathname;
    ...
    const is_no_language = paths.includes('careers') ||  paths.includes('locations') ||  paths.includes('derivtech') ||   paths.includes('derivlife')
  if (has_language_in_url) {
      setLanguageCookie(first_path)
    }
    const user_language = getCookieByKey(document.cookie, 'webflow-user-language')?.toLowerCase() || 'en';
